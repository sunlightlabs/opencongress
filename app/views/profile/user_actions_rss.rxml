    ...
    xml.entry do
      ...
      when 'Comment'
        ...
        when 'ContactCongressLetter'
          xml.title   "Wrote a letter to Congress " + i.formageddon_threads.first.formageddon_letters.first.subject
          xml.link    "rel" => "alternate", "href" => contact_congress_letter(i)
          xml.updated i.created_at.strftime("%Y-%m-%dT%H:%M:%SZ")
          xml.content "type" => "html" do
