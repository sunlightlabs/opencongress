...
CREATE TABLE privacy_options (
    ...
    my_instant_messenger_names integer DEFAULT 0,
...
ALTER TABLE ONLY action_references ALTER COLUMN id SET DEFAULT nextval('action_references_id_seq'::regclass);
...
ALTER TABLE ONLY privacy_options ALTER COLUMN id SET DEFAULT nextval('privacy_options_id_seq'::regclass);
...
ALTER TABLE ONLY refers ALTER COLUMN id SET DEFAULT nextval('refers_id_seq'::regclass);
...
--
-- Name: index_roll_call_votes_on_vote; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX index_roll_call_votes_on_vote ON roll_call_votes USING btree (vote);
...
--
-- Name: testindex1; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX testindex1 ON roll_call_votes USING btree (roll_call_id, vote);


--
-- Name: testindex2; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX testindex2 ON bills USING btree (id, session);
...
--
-- Name: users_order_index; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX users_order_index ON users USING btree (id NULLS FIRST);
...
--
-- Name: zipcode_districts_state_index; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX zipcode_districts_state_index ON zipcode_districts USING btree (state);
...
INSERT INTO schema_migrations (version) VALUES ('20130513185903');
...
INSERT INTO schema_migrations (version) VALUES ('20130906195133');
...
INSERT INTO schema_migrations (version) VALUES ('20131030161823');
